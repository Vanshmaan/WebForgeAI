...
const plans = [
  ...
  },
  {
    ...
    price: "$9",
    credits: 500,
    description: "Best choice for developers and freelancers.",
    features: [
      "300 AI Credits",
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#050505] text-white px-6 pt-16 pb-24">
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-purple-600/70 rounded-full blur-[120px]" />
      </div>
